...
namespace AutomationTrial.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("LoginToTheWebSite")]
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "LoginToTheWebSite", "\tcheck if user can login to the application https://www.nopcommerce.com/", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login as registered user", new string[] {
                        "mytag"});
#line 5
